...
namespace academica.Controllers
{
    public class DocentesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idDocente,codigo,nombre,direccion,telefono,email,dui")] Docente docente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idDocente,codigo,nombre,direccion,telefono,email,dui")] Docente docente)
        {
