...
namespace academica.Controllers
{
    public class AlumnosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idAlumno,codigo,nombre,direccion,telefono")] Alumno alumno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idAlumno,codigo,nombre,direccion,telefono")] Alumno alumno)
        {
