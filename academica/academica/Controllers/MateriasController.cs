...
namespace academica.Controllers
{
    public class MateriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idMateria,codigo,nombre,uv")] Materia materia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idMateria,codigo,nombre,uv")] Materia materia)
        {
